...
| 9 | hybrid_cnn_only | 1.81 M | 0.4853 | CNN stem only |
| 10 | MobileNetV2 | 3.50 M | 0.4738 | |
| 11 | ResNet-18 | 11.69 M | 0.3368 | TTA badly hurts (−0.151) |
...
### 5.2 Hybrid Variants
| Class | hybrid_cnn_only | hybrid_no_meta | hybrid_full |
|---|---|---|---|
| MEL | 0.383 | 0.520 | 0.518 |
| NV | 0.936 | 0.856 | 0.859 |
| BCC | 0.544 | 0.653 | 0.618 |
| AK | 0.645 | 0.426 | 0.587 |
| BKL | 0.296 | 0.669 | 0.632 |
| DF | 0.189 | 0.491 | 0.566 |
| VASC | 0.667 | 0.882 | 0.863 |
| SCC | 0.223 | 0.372 | 0.223 |
...
| Component added | Model | BMA (TTA) | Δ vs previous |
|---|---|---|---|
| CNN stem + GAP only | hybrid_cnn_only | 0.4853 | baseline |
| + ViT trunk + metadata | hybrid_full | 0.6081 | **+0.123 (+25.3%)** |
| ViT trunk, metadata removed | hybrid_no_meta | 0.6085 | +0.0004 vs hybrid_full |

**Note:** On the test set, hybrid_full (0.6081) and hybrid_no_meta (0.6085) are effectively
identical (Δ=0.0004). The validation BMA shows a clearer gap: hybrid_full 0.6505 vs
hybrid_no_meta 0.6395 (+0.011). The metadata effect on generalization is modest at this scale
and cannot be confirmed from a single test-set evaluation.

hybrid_vit_only has not been trained — Table 2 is **incomplete**.
...
|---|---|---|
| hybrid_vit_only | ❌ Not started | Quantify CNN stem gain — completes hybrid ablation Table 2 |
...
| ViT trunk + metadata combined gain | ✅ Supported | hybrid_cnn_only→hybrid_full: +0.123 BMA TTA |
