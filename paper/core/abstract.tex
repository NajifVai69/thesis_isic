...
\vspace{1cm}
\textbf{Keywords:} Skin lesion classification; ISIC-2019; dermoscopy;
CNN--Transformer; metadata fusion; cross-attention; Kolmogorov--Arnold Network;
class imbalance; balanced multi-class accuracy; lightweight deep learning.
\pagebreak
